...
# <editor-fold desc = "Game parameters">
game_running = True
...
# <editor-fold desc = "Image resources rectangles">
...
# <editor-fold desc = "Main menu colored buttons rectangles">
...
# <editor-fold desc = "Main menu buttons colors">
...
# <editor-fold desc = "Texts (main menu scene)">
...
# <editor-fold desc = "Texts (choosing battleships scene + game started scene)">
...
instructions1_text = small_font.render('Instructions: Select ' + str(size_of_battleship) + ' adjacent horizontally '
                                                                                           'or vertically tiles to '
                                                                                           'deploy your '
                                                                                           'battleship.', True,
                                       (255, 255, 255))
instructions2_text = small_font.render(
    'Left click to select tiles. If you change your mind, left click on the reset button.',
    True, (255, 255, 255))
instructions3_text = small_font.render('Instructions: Left click to bombard a tile. If you hit an enemy battleship, '
                                       'a tile with the', True, (255, 255, 255))
instructions4_text = small_font.render('enemy battleship color will appear. If you hit an empty tile, a tile with '
                                       'the white color will', True, (255, 255, 255))
instructions5_text = small_font.render('appear. Don\'t worry, your ship is invulnerable if you hit it by mistake.',
                                       True, (255, 255, 255))
...
invalid_done_text = small_font.render('You need to select ' + str(size_of_battleship) + ' tiles in order to continue!',
                                      True, (255, 0, 0))
